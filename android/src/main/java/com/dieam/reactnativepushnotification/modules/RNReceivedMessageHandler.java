...
public class RNReceivedMessageHandler {
    ...
    public void handleReceivedMessage(RemoteMessage message) {
        ...
        handler.post(new Runnable() {
            public void run() {
                ...
                ReactInstanceManager mReactInstanceManager = ((ReactApplication) mFirebaseMessagingService
                        .getApplication()).getReactNativeHost().getReactInstanceManager();
    ...
    private boolean isApplicationInForeground() {
        ActivityManager activityManager = (ActivityManager) mFirebaseMessagingService
